...
var bio = {
    ...
    "display": function() {
        bio.addTop();
        bio.addContacts("header");
        bio.addBioWelcomeSkills();
        bio.addContacts("footer");
    },
    "addTop": function() {
    ...
    "addContacts": function(target) {
        // FOR SOME REASON These two variables were missing from
...
education = {
    ...
    "display": function() {
        ...
        $.each(education.onlineCourses, function(key, value) {
            ...
            var formattedDates = HTMLonlineDates.replace("%data%", value.date);
            $(".education-entry:last").append(formattedDates);
